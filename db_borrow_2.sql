...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2014 at 09:22 AM
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=999 ;
...
CREATE TABLE IF NOT EXISTS `borrow` (
  ...
  `bor_get` date DEFAULT NULL COMMENT 'วันที่มารับของ',
  `bor_start` date DEFAULT NULL COMMENT 'วันเริ่มใช้งาน',
  `bor_end` date DEFAULT NULL COMMENT 'วันสิ้นสุด',
  `bor_createdate` date NOT NULL,
  `bor_reason` int(11) NOT NULL COMMENT 'เหตุผลการยืม',
  `bor_detail` text NOT NULL,
  `bor_result` int(11) DEFAULT NULL COMMENT '1 = คืนครบ , 2 = ไม่ครบ',
  `bor_remark` text COMMENT 'หมายเหตุ',
  `bor_status` int(11) NOT NULL DEFAULT '0' COMMENT '0 = รอ ,1 = รอ รับของ ,2 = รับของไปแล้ว , 3  = คืน  , 4 = มา รับของ ล่าช้า 5 = ไม่มารับของ , 6 = ยกเลิก',
  `bor_approve` int(11) NOT NULL DEFAULT '0' COMMENT '0 => ยังไม่อนุมัติ , 1 => อนุมัติ จ่ายของ , 2 = อนุมัติ ของพิเศษ',
  PRIMARY KEY (`bor_id`)
...
INSERT INTO `borrow` (`bor_id`, `per_id`, `bor_get`, `bor_start`, `bor_end`, `bor_createdate`, `bor_reason`, `bor_detail`, `bor_result`, `bor_remark`, `bor_status`, `bor_approve`) VALUES
(1, 1, '2014-08-06', '2014-08-14', '2014-08-19', '0000-00-00', 0, '11', 1, '1', 6, 1),
(2, 3, '2014-08-05', '2014-08-12', '2014-08-11', '2014-08-23', 0, 'งาน แต่ง', 2, '-----', 1, 1),
(3, 3, '2014-08-14', '2014-08-27', '2014-08-19', '2014-08-23', 0, '1111', 1, '111', 6, 1),
(4, 3, '2014-08-04', '2014-08-20', '2014-08-12', '2014-08-24', 0, 'ทดสอบ', 1, 'good', 3, 0),
(5, 3, '2014-08-04', '2014-08-20', '2014-08-11', '2014-08-24', 0, '111', 1, '11', 3, 0),
(6, 3, '2014-08-18', '2014-08-05', '2014-08-13', '2014-08-24', 0, '11', 2, '5656', 4, 1),
(7, 3, '2014-08-05', '2014-08-05', '2014-08-12', '2014-08-24', 0, '55555', NULL, NULL, 2, 1),
(8, 3, '2014-08-11', '2014-08-05', '2014-08-21', '2014-08-24', 0, '5454545', NULL, NULL, 1, 1),
(9, 3, '2014-08-11', '2014-08-04', '2014-08-20', '2014-08-24', 0, 'น่ารักอะ', NULL, NULL, 1, 0),
(10, 3, NULL, NULL, NULL, '2014-09-04', 0, '', NULL, NULL, 0, 1),
(11, 3, '2014-09-01', '2014-09-03', '2014-09-09', '2014-09-15', 0, '11111', NULL, NULL, 1, 1),
(12, 3, '2014-09-21', '2014-09-11', '2014-09-09', '2014-09-15', 0, '1111111', NULL, NULL, 2, 1),
(13, 3, NULL, NULL, NULL, '2014-09-15', 0, '', NULL, NULL, 6, 0),
(14, 5, '2014-09-21', '2014-10-10', '2014-10-11', '2014-09-20', 0, '-----', NULL, NULL, 1, 1),
(15, 5, '2014-09-08', '2014-09-10', '2014-09-15', '2014-09-20', 0, '5555', NULL, NULL, 6, 0),
(16, 3, NULL, NULL, NULL, '2014-09-23', 0, '', NULL, NULL, 6, 0),
(17, 3, '2014-09-12', '2014-09-01', '2014-09-19', '2014-09-24', 3, '', NULL, NULL, 1, 1),
(18, 3, '0000-00-00', '0000-00-00', '0000-00-00', '2014-09-24', 0, '4444ffdfdfdfdf', NULL, NULL, 1, 0),
(19, 3, '2014-09-02', '2014-09-02', '2014-09-20', '2014-09-24', 1, '', NULL, NULL, 1, 0),
(20, 3, '2014-09-22', '2014-09-02', '2014-09-26', '2014-09-24', 1, '', NULL, NULL, 1, 0),
(21, 3, '2014-09-12', '2014-09-03', '2014-09-27', '2014-09-24', 2, '', NULL, NULL, 1, 0),
(22, 3, '2014-09-03', '2014-09-01', '2014-09-06', '2014-09-24', 1, '', NULL, NULL, 1, 0),
(23, 3, '2014-09-02', '2014-09-22', '2014-09-09', '2014-09-24', 1, '', NULL, NULL, 1, 0),
(24, 3, NULL, NULL, NULL, '2014-09-24', 0, '', NULL, NULL, 0, 0),
(25, 3, '2014-09-26', '2014-09-02', '2014-09-21', '2014-09-24', 1, '', NULL, NULL, 1, 0),
(26, 3, '2014-09-26', '2014-09-01', '2014-09-05', '2014-09-24', 1, '', NULL, NULL, 1, 0);
...
CREATE TABLE IF NOT EXISTS `borrow_detail` (
  `bordet_id` int(11) NOT NULL AUTO_INCREMENT,
  `bor_id` int(11) NOT NULL,
  `ite_id` int(11) NOT NULL,
  `bordet_no` int(11) NOT NULL COMMENT 'จำนวนของที่ยืม',
  `bordet_approve_no` int(11) NOT NULL COMMENT 'จำนวนของ ที่ จ่ายออกไป',
  `bordet_return_no` int(11) NOT NULL COMMENT 'จำนวนของ คืน',
  `bordet_createdate` datetime NOT NULL,
  PRIMARY KEY (`bordet_id`)
...
INSERT INTO `borrow_detail` (`bordet_id`, `bor_id`, `ite_id`, `bordet_no`, `bordet_approve_no`, `bordet_return_no`, `bordet_createdate`) VALUES
(3, 2, 2, 11, 100, 8888, '2014-08-23 00:00:00'),
(5, 2, 2, 1000, 100, 99999, '2014-08-15 00:00:00'),
(6, 2, 2, 10, 100, 22, '2014-08-23 00:00:00'),
(8, 2, 2, 22, 100, 22, '2014-08-23 00:00:00'),
(9, 2, 12, 10, 100, 10, '2014-08-23 00:00:00'),
(10, 2, 6, 200, 100, 200, '2014-08-23 00:00:00'),
(11, 2, 2, 1111, 100, 1111, '2014-08-23 00:00:00'),
(12, 2, 3, 90, 100, 1, '2014-08-23 00:00:00'),
(14, 3, 2, 12, 100, 6666, '2014-08-23 00:00:00'),
(15, 4, 12, 99, 100, 98, '2014-08-24 00:00:00'),
(16, 4, 6, 11, 100, 12, '2014-08-24 00:00:00'),
(17, 5, 2, 11, 100, 11, '2014-08-24 00:00:00'),
(18, 5, 6, 22, 100, 22, '2014-08-24 00:00:00'),
(19, 5, 7, 333, 100, 333, '2014-08-24 00:00:00'),
(20, 6, 13, 100, 100, 100, '2014-08-24 00:00:00'),
(21, 7, 2, 111, 100, 111, '2014-08-24 17:43:34'),
(22, 8, 5, 111, 100, 111, '2014-08-24 17:47:09'),
(23, 8, 5, 11, 100, 11, '2014-08-24 17:47:24'),
(24, 8, 9, 11, 100, 11, '2014-08-24 17:47:30'),
(25, 8, 6, 55, 100, 55, '2014-08-24 17:47:38'),
(26, 9, 6, 111, 100, 111, '2014-08-24 23:17:27'),
(28, 11, 12, 1, 100, 1, '2014-09-15 21:30:02'),
(29, 11, 3, 3, 100, 3, '2014-09-15 21:30:11'),
(30, 12, 2, 22, 100, 22, '2014-09-15 21:30:58'),
(31, 12, 6, 22, 100, 22, '2014-09-15 21:31:08'),
(35, 14, 4, 4, 100, 4, '2014-09-20 14:01:45'),
(36, 14, 9, 25, 100, 25, '2014-09-20 14:01:59'),
(37, 15, 2, 23, 100, 23, '2014-09-20 14:05:02'),
(38, 16, 2, 10, 100, 10, '2014-09-23 23:33:57'),
(39, 11, 3, 11, 100, 11, '2014-09-24 00:06:38'),
(40, 17, 2, 11, 100, 11, '2014-09-24 21:44:16'),
(41, 18, 5, 33, 100, 33, '2014-09-24 21:46:27'),
(42, 18, 9, 222, 100, 222, '2014-09-24 21:51:45'),
(43, 18, 2, 11, 100, 11, '2014-09-24 21:51:57'),
(44, 19, 6, 22, 100, 22, '2014-09-24 22:09:36'),
(45, 20, 5, 11, 100, 11, '2014-09-24 22:10:30'),
(46, 21, 2, 11, 100, 11, '2014-09-24 22:11:18'),
(47, 22, 2, 11, 100, 11, '2014-09-24 22:12:09'),
(48, 23, 15, 99, 100, 99, '2014-09-24 22:17:50'),
(49, 23, 7, 22, 100, 22, '2014-09-24 22:19:02'),
(50, 25, 5, 22, 100, 22, '2014-09-24 22:23:24'),
(51, 26, 2, 22, 100, 22, '2014-09-24 22:24:20'),
(52, 26, 3, 22, 100, 22, '2014-09-24 22:24:27'),
(53, 26, 15, 44, 100, 44, '2014-09-24 22:24:34');
...
CREATE TABLE IF NOT EXISTS `districts` (
  ...
  `ampure_id` int(11) NOT NULL DEFAULT '0',
  `province_id` int(11) NOT NULL DEFAULT '0',
  `geo_id` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `districts` (`district_id`, `district_code`, `district_name`, `ampure_id`, `province_id`, `geo_id`) VALUES
...
CREATE TABLE IF NOT EXISTS `group` (
  ...
  `gro_name` varchar(150) NOT NULL,
  `gro_createdate` text NOT NULL,
  PRIMARY KEY (`gro_id`)
...
INSERT INTO `group` (`gro_id`, `gro_name`, `gro_createdate`) VALUES
(3, 'จาน', '2014-08-22 23:43:45'),
(5, 'แก้ว', '2014-08-22 23:52:28'),
(6, 'หม้อ', '2014-08-23 00:05:12'),
(7, 'ถาด', '2014-08-23 00:05:32'),
(8, 'ช้อน', '2014-08-23 00:05:44'),
(9, 'ทัพพี', '2014-08-23 00:06:01'),
(10, 'ตะหลิว', '2014-08-23 00:06:14'),
(11, 'ถ้วย', '2014-08-23 00:06:36'),
(12, 'กระบวย', '2014-08-23 00:06:50'),
(13, 'กระละมัง', '2014-08-23 00:07:02'),
(14, 'คูลเลอร์', '2014-08-23 00:07:14'),
(15, 'เหยือกน้ำ', '2014-08-23 00:07:25'),
(16, 'กระทะ', '2014-08-23 00:07:36'),
(17, 'มีด', '2014-08-23 00:08:00'),
(18, 'เตา', '2014-08-23 00:08:10'),
(19, 'เขียง', '2014-08-23 00:08:19'),
(20, 'ผ้าม่าน', '2014-08-23 00:08:37'),
(21, 'โต๊ะ', '2014-08-23 00:08:52'),
(22, 'เก้าอี้', '2014-08-23 00:09:00'),
(23, 'เต้นท์', '2014-08-23 00:09:12'),
(24, 'อาสนะ', '2014-08-23 00:09:55'),
(25, 'กระโถน', '2014-08-23 00:10:05');
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `ite_name` varchar(150) NOT NULL,
  `gro_id` int(11) NOT NULL,
  `typ_id` int(11) NOT NULL,
  `ite_total_no` int(11) NOT NULL COMMENT 'จำนวนทั้งหมด',
  `ite_balance_no` int(11) NOT NULL COMMENT 'ยอดคงเหลือ',
  `siz_id` int(11) NOT NULL,
  `ite_attribute` varchar(50) NOT NULL,
  `ite_priority` int(11) NOT NULL COMMENT '1 = ปกติ , 2 = พิเศษ',
  `ite_status` int(11) NOT NULL COMMENT '1 = ปกติ , 2 = ถูกยืม ,3 = ชำรุด , 4 = สูญหาย',
  `ite_createdate` date NOT NULL,
  `ite_remark` text NOT NULL,
  PRIMARY KEY (`ite_id`)
...
INSERT INTO `item` (`ite_id`, `ite_name`, `gro_id`, `typ_id`, `ite_total_no`, `ite_balance_no`, `siz_id`, `ite_attribute`, `ite_priority`, `ite_status`, `ite_createdate`, `ite_remark`) VALUES
(2, 'หม้อหุงข้าว', 6, 2, 110311, -33, 2, '1', 1, 0, '2014-08-23', 'หม้อหุงข้าว'),
(3, 'กระทะ', 13, 4, 120850, 8888, 4, '1', 1, 0, '2014-08-23', '1'),
(4, 'ผ้าม่าน', 13, 8, 7768, 1111, 3, '1', 1, 0, '2014-08-23', 'รอ ตรวจสอบอีกที'),
(5, 'จานกระเบื้องกลาง', 13, 2, 10100, 111, 4, '1', 1, 0, '2014-08-23', '11'),
(6, 'จานกระเบื้องเล็ก', 13, 2, 9574, 1045, 4, '1', 2, 0, '2014-08-23', '-'),
(7, 'จานสังกะสี', 6, 2, 1000, 1111, 2, '1', 1, 0, '2014-08-23', ''),
(8, 'จานพลาสติก', 13, 2, 1022, 2222, 4, '1', 1, 0, '2014-08-23', ''),
(9, 'ถ้วยกระเบื้องเล็ก', 13, 2, 1080, 222, 4, '1', 1, 0, '2014-08-23', ''),
(10, 'ถ้วยกระเบื้องกลาง', 11, 2, 10167, -1033, 4, '1', 1, 0, '2014-08-23', '111'),
(11, 'ช้อนคาว', 8, 5, 533, 33, 4, '2', 1, 0, '2014-08-23', ''),
(12, 'หม้อเบอร์  ๔๕', 6, 2, 1081, 0, 5, '1', 1, 0, '2014-08-23', ''),
(13, 'หม้อเบอร์  ๔๒', 6, 2, 1000, 0, 6, '1', 1, 0, '2014-08-23', ''),
(14, 'หม้อเบอร์  ๔๐', 6, 2, 100, 0, 7, '1', 1, 0, '2014-08-23', ''),
(15, 'จานเล็ก', 3, 2, 10, 10, 4, '1', 1, 0, '2014-09-20', ''),
(16, 'กระทะ กว้าง', 16, 2, 1111, 1111, 2, '1', 1, 0, '2014-09-23', '111');
...
CREATE TABLE IF NOT EXISTS `person` (
  ...
  `per_username` varchar(30) NOT NULL,
  `per_password` text NOT NULL,
  `per_fname` varchar(150) NOT NULL,
  `per_lname` varchar(150) NOT NULL,
  `per_age` int(2) NOT NULL,
  ...
  `per_zipcode` int(5) NOT NULL,
  `per_tel` varchar(15) NOT NULL,
  `per_email` varchar(50) NOT NULL,
  `per_createdate` date NOT NULL,
  `per_active` int(1) NOT NULL DEFAULT '0' COMMENT '0 = unactive , 1 = active',
  `per_status` int(11) NOT NULL DEFAULT '4' COMMENT '1 = officer, 2 = head officer ,  3 = member',
  PRIMARY KEY (`per_id`)
...
INSERT INTO `person` (`per_id`, `per_username`, `per_password`, `per_fname`, `per_lname`, `per_age`, `per_birthday`, `per_idcard`, `per_address`, `district_id`, `amphure_id`, `province_id`, `per_zipcode`, `per_tel`, `per_email`, `per_createdate`, `per_active`, `per_status`) VALUES
(1, 'admin', '12345678', 'admin', 'admin', 11, '2014-08-06', '123412341234', '1234', 116, 17, 1, 10310, '0870000000', '1234', '2014-08-22', 1, 1),
(3, 'user', '1234', 'Poolsawat', 'Apin', 12, '2014-08-04', '1111111111111', '1', 4964, 551, 36, 48120, '1111111111', 'poon_mp@hotmail.com', '2014-08-23', 1, 3),
(4, 'head', '1234', 'head officer', 'head officer', 99, '2014-08-05', '1219800120650', '189/1', 1216, 153, 12, 22160, '0878356866', 'poon_mp@hotmail.com', '2014-08-24', 1, 2),
(5, 'nick', '1234', 'test', 'test', 23, '2014-05-27', '1234232341232', 'eeeeeee', 1745, 211, 18, 27120, '22', '222', '2014-09-20', 1, 3),
(6, 'poolsawat', 'poolsawat', 'Poolsawat', 'Apin', 24, '1990-04-13', '1219800120650', '189/1 ม.4 ต.กองดิน อ.แกลง จ.ระยอง', 1745, 211, 18, 27120, '0878356866', 'poon_mp@hotmail.com', '2014-09-23', 0, 3);
...
CREATE TABLE IF NOT EXISTS `size` (
  ...
  `siz_name` varchar(150) NOT NULL,
  `gro_id` int(11) NOT NULL,
  `siz_createdate` date NOT NULL,
  PRIMARY KEY (`siz_id`)
...
INSERT INTO `size` (`siz_id`, `siz_name`, `gro_id`, `siz_createdate`) VALUES
(1, '32', 6, '2014-08-23'),
(2, '10', 6, '2014-08-23'),
(3, 'ใหญ่', 13, '2014-08-23'),
(4, 'เล็ก', 13, '2014-08-23'),
(5, '45', 6, '2014-08-23'),
(6, '42', 6, '2014-08-23'),
(7, '40', 6, '2014-08-23'),
(8, '38', 6, '2014-08-23'),
...
INSERT INTO `type` (`typ_id`, `typ_name`, `typ_createdate`) VALUES
(2, 'ใบ', '2014-08-22'),
(3, 'เล่ม', '2014-08-22'),
(4, 'อัน', '2014-08-23'),
(5, 'คัน', '2014-08-23'),
