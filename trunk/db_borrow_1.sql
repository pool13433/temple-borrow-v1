...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2014 at 04:44 PM
...
CREATE TABLE IF NOT EXISTS `borrow` (
  ...
  `bor_result_claim` text COMMENT 'กรณี คืนไม่ครบ ชดใช้อย่างไร',
  `bor_status` int(11) NOT NULL DEFAULT '0' COMMENT '0 = รอ ,1 = รอ ยืม ,2 = ยืม , 3  = คืน  , 4 = มา รับของ ล่าช้า 5 = ไม่มารับของ , 6 = ยกเลิก',
  `bor_approve` int(11) NOT NULL DEFAULT '0' COMMENT '0 => ยังไม่อนุมัติ , 1 => อนุมัติ',
  PRIMARY KEY (`bor_id`)
...
INSERT INTO `borrow` (`bor_id`, `per_id`, `bor_get`, `bor_start`, `bor_end`, `bor_createdate`, `bor_detail`, `bor_result`, `bor_result_claim`, `bor_status`, `bor_approve`) VALUES
(1, 1, '2014-08-06', '2014-08-14', '2014-08-19', '0000-00-00', '11', 1, '1', 6, 1),
(2, 3, '2014-08-05', '2014-08-12', '2014-08-11', '2014-08-23', 'งาน แต่ง', 2, '-----', 3, 1),
(3, 3, '2014-08-14', '2014-08-27', '2014-08-19', '2014-08-23', '1111', 1, '111', 2, 1),
(4, 3, '2014-08-04', '2014-08-20', '2014-08-12', '2014-08-24', 'ทดสอบ', 1, 'good', 3, 0),
(5, 3, '2014-08-04', '2014-08-20', '2014-08-11', '2014-08-24', '111', 1, '11', 3, 0),
(6, 3, '2014-08-18', '2014-08-05', '2014-08-13', '2014-08-24', '11', 2, '5656', 4, 1),
(7, 3, '2014-08-05', '2014-08-05', '2014-08-12', '2014-08-24', '55555', NULL, NULL, 2, 1),
(8, 3, '2014-08-11', '2014-08-05', '2014-08-21', '2014-08-24', '5454545', NULL, NULL, 1, 1),
(9, 3, '2014-08-11', '2014-08-04', '2014-08-20', '2014-08-24', 'น่ารักอะ', NULL, NULL, 1, 0),
(10, 3, NULL, NULL, NULL, '2014-09-04', '', NULL, NULL, 0, 0);
...
INSERT INTO `borrow_detail` (`bordet_id`, `bor_id`, `ite_id`, `bordet_no`, `bordet_return_no`, `bordet_createdate`) VALUES
(3, 2, 2, 11, 8888, '2014-08-23 00:00:00'),
(5, 2, 2, 1000, 99999, '2014-08-15 00:00:00'),
(6, 2, 2, 10, 22, '2014-08-23 00:00:00'),
(7, 2, 4, 3, 3333, '2014-08-23 00:00:00'),
(8, 2, 2, 22, 22, '2014-08-23 00:00:00'),
(9, 2, 12, 10, 10, '2014-08-23 00:00:00'),
(10, 2, 6, 200, 200, '2014-08-23 00:00:00'),
(11, 2, 2, 1111, 1111, '2014-08-23 00:00:00'),
(12, 2, 3, 90, 1, '2014-08-23 00:00:00'),
(13, 2, 6, 1, 1, '2014-08-23 00:00:00'),
(14, 3, 2, 12, 6666, '2014-08-23 00:00:00'),
(15, 4, 12, 99, 98, '2014-08-24 00:00:00'),
(16, 4, 6, 11, 12, '2014-08-24 00:00:00'),
(17, 5, 2, 11, 11, '2014-08-24 00:00:00'),
(18, 5, 6, 22, 22, '2014-08-24 00:00:00'),
(19, 5, 7, 333, 333, '2014-08-24 00:00:00'),
(20, 6, 13, 100, 100, '2014-08-24 00:00:00'),
(21, 7, 2, 111, 111, '2014-08-24 17:43:34'),
(22, 8, 5, 111, 111, '2014-08-24 17:47:09'),
(23, 8, 5, 11, 11, '2014-08-24 17:47:24'),
(24, 8, 9, 11, 11, '2014-08-24 17:47:30'),
(25, 8, 6, 55, 55, '2014-08-24 17:47:38'),
(26, 9, 6, 111, 111, '2014-08-24 23:17:27');
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `ite_no` int(11) NOT NULL COMMENT 'จำนวน',
...
INSERT INTO `item` (`ite_id`, `ite_name`, `gro_id`, `typ_id`, `ite_no`, `siz_id`, `ite_attribute`, `ite_priority`, `ite_status`, `ite_createdate`, `ite_remark`) VALUES
(2, 'หม้อหุงข้าว', 6, 2, 110400, 2, '1', 1, 0, '2014-08-23', 'หม้อหุงข้าว'),
(3, 'กระทะ', 13, 4, 120850, 4, '1', 1, 0, '2014-08-23', '1'),
(4, 'ผ้าม่าน', 13, 8, 7768, 3, '1', 1, 0, '2014-08-23', 'รอ ตรวจสอบอีกที'),
(5, 'จานกระเบื้องกลาง', 3, 2, 10100, 4, '1', 1, 0, '2014-08-23', '11'),
(6, 'จานกระเบื้องเล็ก', 13, 2, 9596, 4, '1', 2, 0, '2014-08-23', '-'),
(7, 'จานสังกะสี', 3, 2, 1000, 2, '1', 1, 0, '2014-08-23', ''),
(8, 'จานพลาสติก', 3, 2, 1022, 4, '1', 1, 0, '2014-08-23', ''),
(9, 'ถ้วยกระเบื้องเล็ก', 11, 2, 1080, 4, '1', 1, 0, '2014-08-23', ''),
(10, 'ถ้วยกระเบื้องกลาง', 11, 2, 11200, 4, '1', 1, 0, '2014-08-23', '111'),
(11, 'ช้อนคาว', 8, 5, 500, 4, '2', 1, 0, '2014-08-23', ''),
(12, 'หม้อเบอร์  ๔๕', 6, 2, 1081, 5, '1', 1, 0, '2014-08-23', ''),
(13, 'หม้อเบอร์  ๔๒', 6, 2, 1000, 6, '1', 1, 0, '2014-08-23', ''),
(14, 'หม้อเบอร์  ๔๐', 6, 2, 100, 7, '1', 1, 0, '2014-08-23', '');
